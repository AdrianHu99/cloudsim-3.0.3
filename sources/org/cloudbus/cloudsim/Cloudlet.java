...
public class Cloudlet {
	...
	/**
	 * The broker or Broker ID. It is advisable that broker set this ID with its own ID, so that
	...
	//here I delete parameter price because the new model
	//public double price;
	...
	public void setpledgeAmount(double amount){
	...
	public Cloudlet(
			...
			final UtilizationModel utilizationModelBw,
			final boolean record) {
		brokerId = -1;          // to be set by a Broker or broker
		status = CREATED;
		pledge = false;
		pledgeAmount = 0.0;
	...
	/**
	 * Sets the broker or owner ID of this Cloudlet. It is <tt>VERY</tt> important to set the broker ID,
	...
	/**
	 * Gets the broker or owner ID of this Cloudlet.
	 * 
	 * @return the broker ID or <tt>-1</tt> if the broker ID has not been set before
	 * @pre $none
	 * @post $result >= -1
	 */
	...
	*/
	 ...
	 * NOTE: This method <tt>should</tt> be called only by a resource entity, not the broker or owner
	 * of this Cloudlet.
	 * 
